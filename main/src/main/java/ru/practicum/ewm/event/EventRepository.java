...
public interface EventRepository extends JpaRepository<Event, Integer> {
    List<Event> findByInitiatorIdOrderByIdDesc(int userId, Pageable pageable);
    ...
    List<Event> findByAdmin(@Param("userIds") Collection<Integer> userIds,
    ...
    Set<Event> findAllByIdIn(Set<Integer> eventsId);
    ...
    @Query("select e from Event e " +
            ...
            "order by count(r.id))) ")
    List<Event> findAllPublic(@Param("text") String text, @Param("categoryIds") Collection<Integer> categoryIds,
